...
int main(void)
{
  ...
  GPIO_InitTypeDef GPIOD_InitStruct = {0};
  GPIOD_InitStruct.Pin   = GPIO_PIN_13;
  GPIOD_InitStruct.Mode  = GPIO_MODE_OUTPUT_PP;
  GPIOD_InitStruct.Pull  = GPIO_NOPULL;
  GPIOD_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOD, &GPIOD_InitStruct);

  GPIO_InitTypeDef GPIOA_InitStruct = {0};
  GPIOA_InitStruct.Pin   = GPIO_PIN_0;
...
//    EXTI_HandleStruct.PendingCallback = NULL;
//
